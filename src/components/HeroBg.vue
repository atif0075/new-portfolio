...
<template>
  <div
    class="absolute -inset-x-8 hidden scale-y-150 opacity-60 sm:dark:block sm:scale-y-100 lg:-top-56"
  >
    <svg
    ...
    >
      <g clip-path="url(#clip0_103_49)">
        <path
          data-color="lime"
          class="fill-lime-950 transition duration-500"
  ...
  <div
    class="absolute dark:hidden inset-0 grid grid-cols-2 -space-x-52 opacity-40 dark:opacity-20"
  >
    <div
